...
public class GlobalException {
    ...
    public ResponseEntity<ErrorDetail> handleCategoryException(CategoryException ae, WebRequest request) {
    ...
    public ResponseEntity<ErrorDetail> handleProductException(ProductException ae, WebRequest request) {
    ...
    public ResponseEntity<ErrorDetail> handleInventoryException(InventoryException ae, WebRequest request) {
